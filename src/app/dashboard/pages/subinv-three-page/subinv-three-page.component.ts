...
@Component({
  selector: 'app-subinv-three-page',
  templateUrl: './subinv-three-page.component.html',
  styleUrl: './subinv-three-page.component.css'
})
export class SubinvThreePageComponent implements OnInit {
