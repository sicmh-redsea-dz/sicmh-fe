...
@Component({
  selector: 'app-visits-v2-or-form-page',
  templateUrl: './visits-v2-or-form-page.component.html',
  styleUrl: './visits-v2-or-form-page.component.css'
})
export class VisitsV2OrFormPageComponent {
  public title = ''
  public subtitle = ''
  public caller = ''
  ...
  ngOnInit(): void {
    ...
    this.visitsService.searchStockItems( 3 )
      .subscribe({
        error: ( err ) => {
    ...
    this.activateRoute.url
      .subscribe((segments) => {
        ...
        if (firstSegment === 'new-visit') {
          this.caller = 'nv'
          this.title = 'Registro de quirofano'
          this.subtitle = 'Agrega los detalles de quirofano.'
          ...
          this.title = 'Editar quirofano'
          this.subtitle = 'Actualiza los detalles de quirofano.'
  ...
  public handleCreateVisit(visit: FormVisitWithStock) {
    ...
    this.visitsService.createVisit( visit, 'oroom' )
      .subscribe({
        next: ( visit ) => {
          if( visit ) {
